...
public class InventoryDao {
    ...
    public List<Inventory> getInventoryByProductId(int idProduct) {
        try {
            return jdbi.withHandle(handle ->
                    handle.createQuery("SELECT * FROM inventory WHERE idProduct = :idProduct")
                            .bind("idProduct", idProduct)
                            .map((rs, ctx) -> new Inventory(
                                    rs.getInt("id"),
                                    rs.getInt("idProduct"),
    ...
    public List<Inventory> getInventoryByWareHouseId(int idWareHouse) {
        try {
            return jdbi.withHandle(handle ->
    ...
    public List<Inventory> getInventoryByProductIdAndDateRange(int idProduct, Date startDate, Date endDate) {
        try {
            return jdbi.withHandle(handle ->
                    handle.createQuery("""
