...
-- Server OS:                    Win64
-- Combined, Optimized, and Reordered Full Script
-- --------------------------------------------------------
...
/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */; -- Disable FK checks
...
CREATE TABLE `addresses` (
                             ...
                             KEY `idx_address_province` (`province`)
...
CREATE TABLE `prices` (
                          ...
                          PRIMARY KEY (`id`) USING BTREE,
                          KEY `idx_prices_lastprice` (`lastPrice`),
                          KEY `idx_prices_dates` (`startDate`,`endDate`)
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Lưu trữ các vai trò người dùng' ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `vouchers` (
                            ...
                            UNIQUE KEY `uk_voucher_code` (`code`) USING BTREE,
                            KEY `idx_vouchers_active_dates` (`isActive`,`startDate`,`endDate`)
...
CREATE TABLE `contact_info` (
                                ...
                                CONSTRAINT `contact_info_ibfk_1` FOREIGN KEY (`idAddress`) REFERENCES `addresses` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dependencies: categories, technical_information, prices
CREATE TABLE `products` (
                            ...
                            KEY `products_idprice_foreign` (`idPrice`) USING BTREE,
                            KEY `idx_products_name` (`name`),
                            KEY `idx_products_selling` (`selling`),
                            ...
                            CONSTRAINT `products_idprice_foreign` FOREIGN KEY (`idPrice`) REFERENCES `prices` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Lưu trữ token xác thực, đặt lại mật khẩu,...' ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `user_providers` (
                                  ...
                                  PRIMARY KEY (`id`) USING BTREE,
                                  UNIQUE KEY `uk_user_provider_id` (`provider_name`,`provider_id`) USING BTREE,
                                  UNIQUE KEY `uk_user_provider_user` (`user_id`,`provider_name`) USING BTREE,
                                  KEY `fk_user_providers_user` (`user_id`) USING BTREE,
                                  CONSTRAINT `fk_user_providers_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='Stores third-party provider login information for users (e.g., Google, Facebook)';

-- Dependencies: users, vouchers
CREATE TABLE `orders` (
                          `id` int(11) NOT NULL AUTO_INCREMENT,
                          ...
                          KEY `idx_orders_status` (`statusOrder`),
                          KEY `idx_orders_time` (`timeOrder`),
...
CREATE TABLE `deliveries` (
                              ...
                              KEY `idx_deliveries_order` (`idOrder`),
                              ...
                              CONSTRAINT `deliveries_idorder_foreign` FOREIGN KEY (`idOrder`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `cart` (
                        ...
                        CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
                        CONSTRAINT `cart_ibfk_2` FOREIGN KEY (`idVoucher`) REFERENCES `vouchers` (`idVoucher`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dependencies: vouchers, users, orders
CREATE TABLE `voucher_usage` (
                                 ...
                                 PRIMARY KEY (`id`) USING BTREE,
                                 KEY `fk_voucher_usage_voucher` (`voucher_id`) USING BTREE,
                                 KEY `fk_voucher_usage_user` (`user_id`) USING BTREE,
                                 KEY `fk_voucher_usage_order` (`order_id`) USING BTREE,
                                 CONSTRAINT `fk_voucher_usage_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
                                 CONSTRAINT `fk_voucher_usage_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
                                 CONSTRAINT `fk_voucher_usage_voucher` FOREIGN KEY (`voucher_id`) REFERENCES `vouchers` (`idVoucher`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='Stores records of voucher usage in orders';

-- Dependencies: cart, styles
CREATE TABLE `cart_items` (
                              ...
                              KEY `idStyle` (`idStyle`),
                              CONSTRAINT `cart_items_ibfk_1` FOREIGN KEY (`idCart`) REFERENCES `cart` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
                              CONSTRAINT `cart_items_ibfk_2` FOREIGN KEY (`idStyle`) REFERENCES `styles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dependencies: orders, styles
CREATE TABLE `order_details` (
                                 ...
                                 PRIMARY KEY (`id`) USING BTREE,
                                 KEY `idx_order_details_order` (`idOrder`),
                                 KEY `idx_order_details_style` (`idStyle`),
                                 CONSTRAINT `fk_order_details_order` FOREIGN KEY (`idOrder`) REFERENCES `orders` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
                                 CONSTRAINT `fk_order_details_style` FOREIGN KEY (`idStyle`) REFERENCES `styles` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
-- Server version:               10.4.32-MariaDB - mariadb.org binary distribution
-- Server OS:                    Win64
-- Combined, Optimized, Reordered, and Formatted Full Script
-- --------------------------------------------------------
...
INSERT INTO `vouchers` (`idVoucher`, `code`, `description`, `discountType`, `discountValue`, `minimumSpend`, `maxDiscountAmount`, `startDate`, `endDate`, `maxUses`, `usesPerCustomer`, `isActive`) VALUES
                                                                                                                                                                                                        (1, 'VOUCHER01', NULL, 'FIXED', 100000.00, 500000.00, NULL, NULL, NULL, NULL, NULL, 1),
                                                                                                                                                                                                        (2, 'VOUCHER02', NULL, 'FIXED', 20000.00, 200000.00, NULL, NULL, NULL, NULL, NULL, 1),
                                                                                                                                                                                                        (3, 'VOUCHER03', NULL, 'FIXED', 150000.00, 750000.00, NULL, NULL, NULL, NULL, NULL, 1),
                                                                                                                                                                                                        (4, 'VOUCHER04', NULL, 'FIXED', 300000.00, 1500000.00, NULL, NULL, NULL, NULL, NULL, 1),
                                                                                                                                                                                                        (5, 'VOUCHER05', NULL, 'FIXED', 250000.00, 1000000.00, NULL, NULL, NULL, NULL, NULL, 1);
...
INSERT INTO `styles` (`id`, `idProduct`, `name`, `image`, `quantity`) VALUES
                                                                          (446, 185, 'Linen Bột xanh da trời', 'https://product.hstatic.net/200000898773/product/linen-bot-mat__3__3c9c3f26e7224b4796827ae0b001f3ab_master.jpg', 1),
                                                                          (447, 185, 'Linen Bột trắng tinh', 'https://product.hstatic.net/200000898773/product/linen-bot-mat__4__497a1b76ddab4fe1b48533cc9273ed3b_master.jpg', 1),
                                                                          (448, 185, 'Linen Bột Muối tiêu', 'https://product.hstatic.net/200000898773/product/linen-bot-mat__7__61ffb81f86fe4800b1d735d89a0e35f3_master.jpg', 1),
                                                                          (449, 185, 'Linen Bột đen', 'https://product.hstatic.net/200000898773/product/linen-bot-mat__15__0c9852186a4b4d7788669457e4bc2594_master.jpg', 1),
                                                                          (450, 185, 'Linen Bột xanh Carolina', 'https://product.hstatic.net/200000898773/product/z4854448267372_cb08f468ebcedd209900293a18c40cc7_49fedc489e174f81892ace51c9e8cb64_master.jpg', 1),
                                                                          (451, 186, 'Linen Tưng Hàn Kem', 'https://product.hstatic.net/200000898773/product/upload_8bceb0438f664f5ea5dacfa31e87af76_master.jpg', 1),
                                                                          (452, 186, 'Linen Tưng Hàn Xanh da trời', 'https://product.hstatic.net/200000898773/product/upload_bd349e85b0894056b62b208d3c48e2ed_master.jpg', 1),
                                                                          (453, 186, 'Linen Tưng Hàn đen', 'https://product.hstatic.net/200000898773/product/02_4c6680d5388a41a68e94fab7227b37cd_master.jpg', 1),
                                                                          (454, 186, 'Linen Tưng Hàn nâu', 'https://product.hstatic.net/200000898773/product/07_57d4fd19520d40b58014cce3fc551605_master.jpg', 1),
                                                                          (455, 187, 'Linen Bố Gân do nhung', 'https://product.hstatic.net/200000898773/product/01_a78977897050428591120b8fe5ca8686_master.jpg', 1),
                                                                          (456, 187, 'Linen Bố Gân xanh lá', 'https://product.hstatic.net/200000898773/product/02_4976a7977cb945478b9076be4b9b9356_master.jpg', 1),
                                                                          (457, 187, 'Linen Bố Gân da đậm', 'https://product.hstatic.net/200000898773/product/04_dcaef903b11e4fb597b5d776c069d5a3_master.jpg', 1),
                                                                          (458, 187, 'Linen Bố Gân trắng', 'https://product.hstatic.net/200000898773/product/07_08131ef255c34d9b99409ca613b3a475_master.jpg', 1),
                                                                          (459, 188, 'Linen cotton lạnh Hồng baby', 'https://product.hstatic.net/200000898773/product/01_d446d33fcbc24e4f89b90a3829908942_master.jpg', 1),
                                                                          (460, 188, 'Linen cotton lạnh xanh đen', 'https://product.hstatic.net/200000898773/product/15_2567b2293f564bbfaee710cf21c855cd_master.jpg', 1),
                                                                          (461, 188, 'Linen cotton lạnh nâu cacao', 'https://product.hstatic.net/200000898773/product/24_31003a51e2e44d98b6c10ad989b4b798_master.jpg', 1),
                                                                          (462, 188, 'Linen cotton lạnh xanh dâu', 'https://product.hstatic.net/200000898773/product/110-vai-linen-cotton-lanh-min-mat-chong-nhan-may-so-mi-vay-dam-bo__17__37c31b1635794331a2f0147fa8e179e9_master.jpg', 1),
                                                                          (463, 189, 'Linen tưng ướt đen', 'https://product.hstatic.net/200000898773/product/03-vai-linen-tung-uot-premium-may-ao-so-mi-vay-dam-set-bo-thiet-ke__2__abf3b6e1abe9414ba4af1b52a5327c27_master.jpg', 1),
                                                                          (464, 189, 'Linen tưng ướt muối tiêu', 'https://product.hstatic.net/200000898773/product/03-vai-linen-tung-uot-premium-may-ao-so-mi-vay-dam-set-bo-thiet-ke__3__a26009d329f347f990b6c7c706e074b0_master.jpg', 1),
                                                                          (465, 189, 'Linen tưng ướt xanh đá', 'https://product.hstatic.net/200000898773/product/3-vai-linen-tung-uot-premium-may-ao-so-mi-vay-dam-set-bo-thiet-ke__14__b00f01469f4b43d0a98a6e1e6e2a0833_master.jpg', 1),
                                                                          (466, 189, 'Linen tưng ướt Xanh cameo', 'https://product.hstatic.net/200000898773/product/3-vai-linen-tung-uot-premium-may-ao-so-mi-vay-dam-set-bo-thiet-ke__17__da23073faba34a5d80fd0d7a37126855_master.jpg', 1),
                                                                          (467, 190, 'Linen bamboo trắng', 'https://product.hstatic.net/200000898773/product/upload_b550ba94cece49ab866741d7a9d92388_master.jpg', 1),
                                                                          (468, 191, 'Linen bột dày', 'https://product.hstatic.net/200000898773/product/11_1000ff25414e489cb85ae7666f58dd39_master.jpg', 1),
                                                                          (469, 191, 'Linen bột dày trắng', 'https://product.hstatic.net/200000898773/product/11_1000ff25414e489cb85ae7666f58dd39_master.jpg', 1),
                                                                          (470, 192, 'Linen gân nhật xanh', 'https://product.hstatic.net/200000898773/product/upload_5797bb8020dd43ccbeb6efcb1ac70036_master.jpg', 1),
                                                                          (471, 192, 'Linen gân nhật đen', 'https://product.hstatic.net/200000898773/product/vai-linen-gan-nhat__11__3c4a4b3c897f4b6f9c598647c72c83a2_master.jpg', 1),
                                                                          (472, 192, 'Linen gân nhật trắng', 'https://product.hstatic.net/200000898773/product/vai-linen-gan-nhat__12__db74a652f477491c9203d013d78fe178_master.jpg', 1),
                                                                          (473, 192, 'Linen gân nhật xanh da trời', 'https://product.hstatic.net/200000898773/product/vai-linen-gan-nhat__15__8f698b4ea4464c429b4d0cd59343edbb_master.jpg', 1),
                                                                          (474, 192, 'Linen gân nhật đỏ', 'https://product.hstatic.net/200000898773/product/vai-linen-gan-nhat__17__ebf67c37e8f54bd8b20141465b8d3b92_master.jpg', 1),
                                                                          (475, 193, 'Thun gân tăm trắng gạo', 'https://product.hstatic.net/200000898773/product/upload_7b0850c4e69c4820a974d52124f55870_master.jpg', 1),
                                                                          (476, 193, 'Thun gân tăm đen', 'https://product.hstatic.net/200000898773/product/upload_5620aff9c123413f8323cace13ef71ea_master.jpg', 1),
                                                                          (477, 193, 'Thun gân tăm xanh bơ', 'https://product.hstatic.net/200000898773/product/z5688530491253_0eb312480a5291d811e547f48a6cc240_d231f089ac944eb5a42b026369dd6afa_master.jpg', 1),
                                                                          (478, 193, 'Thun gân tăm tím', 'https://product.hstatic.net/200000898773/product/z5688530497370_676caab435a983767b69b6cc119c56291_cd3610714f0d4f6e9c43199f282dfa07_master.jpg', 1),
                                                                          (479, 193, 'Thun gân tăm cam', 'https://product.hstatic.net/200000898773/product/z5688530539659_a81d2662501c6ee51cd1d113901f2790_53b596d9f2e3482cb11c9d31a5569d42_master.jpg', 1),
                                                                          (480, 194, 'Thun sóng kem', 'https://product.hstatic.net/200000898773/product/z5695162812219_b2077366ce331cb8d28436db56d75145_5ea0644732f049e28b312b302a2c4898_master.jpg', 1),
                                                                          (481, 194, 'Thun sóng trắng', 'https://product.hstatic.net/200000898773/product/z5695249703766_01a067b78d41ec98d1c49c72c6b173d2_4132b186f4884f32a30cf9901ced757e_master.jpg', 1),
                                                                          (482, 194, 'Thun sóng xanh bơ', 'https://product.hstatic.net/200000898773/product/z5695262408270_010df517460e6958e38619fd838f5364_b2977f81caea4f3ab8f67ffbc7c24a37_master.jpg', 1),
                                                                          (483, 194, 'Thun sóng hồng', 'https://product.hstatic.net/200000898773/product/z5695286517664_fe6e421a316cfea8e3d02ae8b1482de6_c87476f1d2bc4124a970e4f91f588f14_master.jpg', 1),
                                                                          (484, 194, 'Thun sóng đen', 'https://product.hstatic.net/200000898773/product/z5695336161796_87dfc4713a21fbe7eb54b131f8571814_34496a1931c340188aaf7fdd47914d9f_master.jpg', 1),
                                                                          (485, 195, 'Thun giấy xanh môn', 'https://product.hstatic.net/200000898773/product/z5694869951710_480014f65edff1f194e8c46e42842fc5_b3157a89fe124cdeadc3421214fd2413_master.jpg', 1),
                                                                          (486, 195, 'Thun giấy đen', 'https://product.hstatic.net/200000898773/product/z5694881209741_d2891080adc3189224049a807ac180d9_ff59991b45974abeb14916756d81413f_master.jpg', 1),
                                                                          (487, 195, 'Thun giấy nâu tây', 'https://product.hstatic.net/200000898773/product/z5694911231190_18a609cdb04008bcf04a6bf0eba239c3_964a2b34db02498784e4f0cfef795c7d_master.jpg', 1),
                                                                          (488, 195, 'Thun giấy xanh bơ', 'https://product.hstatic.net/200000898773/product/z5694949143266_a5de9130ae5c590978d7bbe21cd260c6_7f3532b2117345a589f632ae6d7e01a4_master.jpg', 1),
                                                                          (489, 195, 'Thun giấy dâu', 'https://product.hstatic.net/200000898773/product/z5695003886475_8172008fbf4873fc271b4240a8f33e09_ba61adb45301475eafe3233e7811dc63_master.jpg', 1),
                                                                          (490, 196, 'Thun xốp nhật xanh rêu', 'https://product.hstatic.net/200000898773/product/204-vai-thun-xop-nhat-co-gian-4c__10__0affb4ee142e4727a15e44ec40536c1e_master.jpg', 1),
                                                                          (491, 196, 'Thun xốp nhật xanh bơ', 'https://product.hstatic.net/200000898773/product/204-vai-thun-xop-nhat-co-gian-4c__11__0c394427e51e4c0f84558b11b9521b8b_master.jpg', 1),
                                                                          (492, 196, 'Thun xốp nhật đen', 'https://product.hstatic.net/200000898773/product/204-vai-thun-xop-nhat-co-gian-4c__12__a82a1eec56ee43b2a025dc6b2a1e5cfe_master.jpg', 1),
                                                                          (493, 196, 'Thun xốp nhật tím cà', 'https://product.hstatic.net/200000898773/product/204-vai-thun-xop-nhat-co-gian-4c__13__03e3a6cc717d4f54a257fb40526b081d_master.jpg', 1),
                                                                          (494, 196, 'Thun xốp nhật đỏ nhung', 'https://product.hstatic.net/200000898773/product/204-vai-thun-xop-nhat-co-gian-4c__15__82c40cbdc07d4142bfab76be5193b58c_master.jpg', 1),
                                                                          (495, 197, 'Thun ướt xanh lá', 'https://product.hstatic.net/200000898773/product/vai-thun-uot-co-gian-4c__14__d97f0e37f9fc4ff387e5e1786938681b_master.jpg', 1),
                                                                          (496, 197, 'Thun ướt dâu nhạt', 'https://product.hstatic.net/200000898773/product/vai-thun-uot-co-gian-4c__15__dc3c942a9ecf492d8f4f8b0902f6806c_master.jpg', 1),
                                                                          (497, 197, 'Thun ướt đen', 'https://product.hstatic.net/200000898773/product/vai-thun-uot-co-gian-4c__16__2fc0508b44cf406cb411fca66b294a3b_master.jpg', 1),
                                                                          (498, 197, 'Thun ướt kem', 'https://product.hstatic.net/200000898773/product/vai-thun-uot-co-gian-4c__17__7fd299d6fe594ea597ccddc1402dc6d8_master.jpg', 1),
                                                                          (499, 198, 'Lưới thun dẻo trắng', 'https://product.hstatic.net/200000898773/product/771-vai-luoi-thun-deo-co-gian-may-dam-vay-set-bo-thiet-ke___5__bf0f18030726476f8d9aec354ea2a90b_master.jpg', 1),
                                                                          (500, 198, 'Lưới thun dẻo đen', 'https://product.hstatic.net/200000898773/product/771-vai-luoi-thun-deo-co-gian-may-dam-vay-set-bo-thiet-ke___6__cf06dc64b4074e16bebbd5d2f62216f1_master.jpg', 1),
                                                                          (501, 198, 'Lưới thun dẻo xanh mint', 'https://product.hstatic.net/200000898773/product/771-vai-luoi-thun-deo-co-gian-may-dam-vay-set-bo-thiet-ke___7__9e0c8c4fb14a4fe4a4934aca86f82455_master.jpg', 1),
                                                                          (502, 198, 'Lưới thun dẻo be', 'https://product.hstatic.net/200000898773/product/771-vai-luoi-thun-deo-co-gian-may-dam-vay-set-bo-thiet-ke___9__af027d046a5042f79a2b27d2d2935e0c_master.jpg', 1),
                                                                          (503, 198, 'Lưới thun dẻo đỏ', 'https://product.hstatic.net/200000898773/product/771-vai-luoi-thun-deo-co-gian-may-dam-vay-set-bo-thiet-ke___10__bdb42b4fc04d485ba2f5066fbbb12649_master.jpg', 1),
                                                                          (504, 199, 'Thun cotton 100% 2 chiều trắng', 'https://product.hstatic.net/200000898773/product/vai-thun-cotton-100-_-250-gsm-2-chieu__2__a088f7256a584e94a8697c9fe2223e95_master.jpg', 1),
                                                                          (505, 199, 'Thun cotton 100% 2 chiều xám chì', 'https://product.hstatic.net/200000898773/product/vai-thun-cotton-100-_-250-gsm-2-chieu__4__69e363c9f804428ca94f70c57243fc3a_master.jpg', 1),
                                                                          (506, 200, 'Thun hàn dày đen', 'https://product.hstatic.net/200000898773/product/vai-thun-han-day__10__88d7ac21b4914e36a8930be98ed9982f_master.jpg', 1),
                                                                          (507, 200, 'Thun hàn dày hồng sen', 'https://product.hstatic.net/200000898773/product/vai-thun-han-day__20__40f92a2bf9d344c58a439b1ca919f48c_master.jpg', 1),
                                                                          (508, 200, 'Thun hàn dày nâu bò', 'https://product.hstatic.net/200000898773/product/vai-thun-han-day__21__310bfcfd3b404744a6c1e2e500dc163b_master.jpg', 1),
                                                                          (509, 200, 'Thun hàn dày xanh than', 'https://product.hstatic.net/200000898773/product/vai-thun-han-day__23__68f8552a2c39426ca322f8d4719e1c42_master.jpg', 1),
                                                                          (510, 200, 'Thun hàn dày tím', 'https://product.hstatic.net/200000898773/product/vai-thun-han-day__24__41f73b37c16d41b0a4a2fa32062ba1de_master.jpg', 1),
                                                                          (511, 201, 'Thun tăm lạnh đen', 'https://product.hstatic.net/200000898773/product/200-vai-thun-tam-lanh-may-ao-thun-vay-dam-do-bo-thiet-ke__11__41a32a53dc3d4100b85bfbcf4e1a6c33_master.jpg', 1),
                                                                          (512, 201, 'Thun tăm lạnh trắng', 'https://product.hstatic.net/200000898773/product/200-vai-thun-tam-lanh-may-ao-thun-vay-dam-do-bo-thiet-ke__12__2c681098a3a345a892f50efeb45eb28c_master.jpg', 1),
                                                                          (513, 201, 'Thun tăm lạnh be', 'https://product.hstatic.net/200000898773/product/200-vai-thun-tam-lanh-may-ao-thun-vay-dam-do-bo-thiet-ke__13__7826eac35acf4de38cb2f45152ef2792_master.jpg', 1),
                                                                          (514, 201, 'Thun tăm lạnh dâu', 'https://product.hstatic.net/200000898773/product/200-vai-thun-tam-lanh-may-ao-thun-vay-dam-do-bo-thiet-ke__15__0f30cbc373e54455b04e24a804749389_master.jpg', 1),
                                                                          (515, 201, 'Thun tăm lạnh nâu tây', 'https://product.hstatic.net/200000898773/product/200-vai-thun-tam-lanh-may-ao-thun-vay-dam-do-bo-thiet-ke__16__5abf4e7f17f9441c920acd0aba60307e_master.jpg', 1),
                                                                          (516, 202, 'Thun co dãn hồng', 'https://product.hstatic.net/200000898773/product/upload_0bcc75beed7947f48221dff7d307d8cf_master.jpg', 1),
                                                                          (517, 202, 'Thun co dãn trắng', 'https://product.hstatic.net/200000898773/product/upload_52b9534b525b41c19fb63ecf3aeec87f_master.jpg', 1),
                                                                          (518, 203, 'Kaki xước hoa nổi xám', 'https://product.hstatic.net/200000898773/product/506-vai-kaki-xuoc-hoa-noi-may-quan-tay-vay-dam-vest-thiet-ke__1__4040d7da88fa4535b126ca1947e43302_master.jpg', 1),
                                                                          (519, 204, 'Jean Chấm Xanh', 'https://product.hstatic.net/200000898773/product/upload_2396fab85c0f4dbca287bd126d2fe21b_master.jpg', 1),
                                                                          (520, 205, 'Jean demin xanh biển', 'https://product.hstatic.net/200000898773/product/1_17e7f222863045308ee85bce8f9ad869_master.jpg', 1),
                                                                          (521, 205, 'Jean demin xanh nhạt', 'https://product.hstatic.net/200000898773/product/2_5dada4e4169e4a3ea4b76087d6c0792c_master.jpg', 1),
                                                                          (522, 205, 'Jean demin xanh trung', 'https://product.hstatic.net/200000898773/product/3_223f83a720864c60b0efc52d1f745cae_master.jpg', 1),
                                                                          (523, 206, 'Jean lụa xanh đậm', 'https://product.hstatic.net/200000898773/product/01_c7e963b8124246be914310ddad9491f6_master.jpg', 1),
                                                                          (524, 206, 'Jean lụa xanh nhạt', 'https://product.hstatic.net/200000898773/product/02_714a147e40c54d088abce23e6d70218e_master.jpg', 1),
                                                                          (525, 206, 'Jean lụa đen', 'https://product.hstatic.net/200000898773/product/03_8eebfbf420ea461d8666261d53d392f6_master.jpg', 1),
                                                                          (526, 207, 'Jean loang xanh', 'https://product.hstatic.net/200000898773/product/802-vai-jean-loang-may-quan-jean-ao-khoac-vay-dam-set__11__bb6154c33757486f913fa3f0584e8260_master.jpg', 1),
                                                                          ...
                                                                          (633, 223, 'Màu Đen', 'https://down-vn.img.susercontent.com/file/cn-11134207-7ras8-m0mv6417cxyla9', 47),
...
-- Chú ý: Dữ liệu cho order_details đang bị bình luận do idStyle không khớp với id trong bảng styles.
-- Hãy sửa các giá trị idStyle trong khối INSERT này để tham chiếu đúng id trong bảng styles rồi mới bỏ bình luận và chạy lại.

INSERT INTO `order_details` (`id`, `idOrder`, `idStyle`, `quantity`, `totalPrice`, `weight`) VALUES
                                                                                                 (1, 1, 463, 2, 300000, 1.5),
                                                                                                 (2, 1, 489, 1, 150000, 0.7),
                                                                                                 (3, 2, 511, 3, 450000, 2),
                                                                                                 (4, 2, 533, 4, 600000, 3.2),
                                                                                                 (5, 3, 456, 1, 120000, 0.5),
                                                                                                 (6, 3, 478, 2, 240000, 1),
                                                                                                 (7, 4, 500, 5, 750000, 4),
                                                                                                 (8, 4, 522, 1, 150000, 0.8),
                                                                                                 (9, 5, 534, 2, 300000, 1.4),
                                                                                                 (10, 5, 567, 3, 450000, 2.1),
                                                                                                 (11, 6, 578, 1, 150000, 0.6),
                                                                                                 (12, 6, 589, 2, 300000, 1.2),
                                                                                                 (13, 7, 600, 4, 600000, 2.5),
                                                                                                 (14, 7, 611, 1, 120000, 0.4),
                                                                                                 (15, 8, 622, 3, 450000, 1.9),
                                                                                                 (16, 8, 463, 2, 300000, 1.3),
                                                                                                 (17, 9, 455, 1, 150000, 0.7),
                                                                                                 (18, 9, 466, 5, 750000, 3.8),
                                                                                                 (19, 10, 477, 2, 300000, 1.4),
                                                                                                 (20, 10, 488, 3, 450000, 2),
                                                                                                 (21, 11, 499, 1, 150000, 0.8),
                                                                                                 (22, 11, 510, 4, 600000, 3.1),
                                                                                                 (23, 12, 521, 2, 300000, 1.2),
                                                                                                 (24, 12, 532, 3, 450000, 2.1),
                                                                                                 (25, 13, 543, 5, 750000, 4.5),
                                                                                                 (26, 13, 554, 1, 150000, 0.9),
                                                                                                 (27, 14, 565, 2, 300000, 1.4),
                                                                                                 (28, 14, 576, 4, 600000, 2.8),
                                                                                                 (29, 15, 587, 3, 450000, 2),
                                                                                                 (30, 15, 598, 2, 300000, 1.3),
                                                                                                 (31, 16, 609, 1, 150000, 0.7),
                                                                                                 (32, 16, 620, 5, 750000, 3.9),
                                                                                                 (33, 17, 631, 2, 300000, 1.2),
                                                                                                 (34, 17, 446, 3, 450000, 2.4),
                                                                                                 (35, 18, 457, 4, 600000, 3),
                                                                                                 (36, 18, 468, 1, 150000, 0.8),
                                                                                                 (37, 19, 479, 2, 300000, 1.5),
                                                                                                 (38, 19, 490, 3, 450000, 2.3),
                                                                                                 (39, 20, 501, 5, 750000, 4.7),
                                                                                                 (40, 20, 512, 1, 150000, 0.9),
                                                                                                 (41, 1, 467, 2, 300000, 1.5),
                                                                                                 (42, 1, 489, 1, 150000, 0.7),
                                                                                                 (43, 2, 511, 3, 450000, 2),
                                                                                                 (44, 2, 533, 4, 600000, 3.2),
                                                                                                 (45, 3, 456, 1, 120000, 0.5),
                                                                                                 (46, 3, 478, 2, 240000, 1),
                                                                                                 (47, 4, 500, 5, 750000, 4),
                                                                                                 (48, 4, 522, 1, 150000, 0.8),
                                                                                                 (49, 5, 534, 2, 300000, 1.4),
                                                                                                 (50, 5, 567, 3, 450000, 2.1),
                                                                                                 (51, 6, 578, 1, 150000, 0.6),
                                                                                                 (52, 6, 589, 2, 300000, 1.2),
                                                                                                 (53, 7, 600, 4, 600000, 2.5),
                                                                                                 (54, 7, 611, 1, 120000, 0.4),
                                                                                                 (55, 8, 622, 3, 450000, 1.9),
                                                                                                 (56, 8, 463, 2, 300000, 1.3),
                                                                                                 (57, 9, 455, 1, 150000, 0.7),
                                                                                                 (58, 9, 466, 5, 750000, 3.8),
                                                                                                 (59, 10, 477, 2, 300000, 1.4),
                                                                                                 (60, 10, 488, 3, 450000, 2),
                                                                                                 (61, 11, 499, 1, 150000, 0.8),
                                                                                                 (62, 11, 510, 4, 600000, 3.1),
                                                                                                 (63, 12, 521, 2, 300000, 1.2),
                                                                                                 (64, 12, 532, 3, 450000, 2.1),
                                                                                                 (65, 13, 543, 5, 750000, 4.5),
                                                                                                 (66, 13, 554, 1, 150000, 0.9),
                                                                                                 (67, 14, 565, 2, 300000, 1.4),
                                                                                                 (68, 14, 576, 4, 600000, 2.8),
                                                                                                 (69, 15, 587, 3, 450000, 2),
                                                                                                 (70, 15, 598, 2, 300000, 1.3),
                                                                                                 (71, 16, 609, 1, 150000, 0.7),
                                                                                                 (72, 16, 620, 5, 750000, 3.9),
                                                                                                 (73, 17, 631, 2, 300000, 1.2),
                                                                                                 (74, 17, 446, 3, 450000, 2.4),
                                                                                                 (75, 18, 457, 4, 600000, 3),
                                                                                                 (76, 18, 468, 1, 150000, 0.8),
                                                                                                 (77, 19, 479, 2, 300000, 1.5),
                                                                                                 (78, 19, 490, 3, 450000, 2.3),
                                                                                                 (79, 20, 501, 5, 750000, 4.7),
                                                                                                 (80, 20, 512, 1, 150000, 0.9),
                                                                                                 (83, 17, 590, 1, 450000, 0.5),
                                                                                                 (84, 17, 592, 10, 2850000, 5),
                                                                                                 (85, 18, 589, 10, 4500000, 5),
                                                                                                 (86, 19, 589, 10, 4500000, 5),
                                                                                                 (87, 19, 591, 10, 2850000, 5),
                                                                                                 (88, 20, 589, 10, 4500000, 5),
                                                                                                 (89, 21, 589, 10, 4500000, 5),
                                                                                                 (90, 21, 616, 2, 1520000, 1),
                                                                                                 (91, 25, 589, 3, 1350000, 1.5),
                                                                                                 (92, 25, 592, 10, 2850000, 5),
                                                                                                 (93, 25, 592, 10, 2850000, 5),
                                                                                                 (94, 26, 449, 10, 19000, 5),
                                                                                                 (95, 26, 617, 1, 760000, 0.5),
                                                                                                 (96, 26, 592, 1, 285000, 0.5),
                                                                                                 (97, 27, 589, 10, 4500000, 5),
                                                                                                 (98, 28, 591, 1, 285000, 0.5),
                                                                                                 (99, 28, 637, 1, 540000, 0.5),
                                                                                                 (100, 28, 640, 1, 220000, 0.5),
                                                                                                 (101, 28, 627, 1, 467500, 0.5),
                                                                                                 (102, 29, 592, 10, 2850000, 5),
                                                                                                 (103, 29, 619, 2, 738000, 1),
                                                                                                 (104, 29, 604, 2, 595000, 1),
                                                                                                 (105, 30, 446, 1, 4500, 0.5),
                                                                                                 (106, 30, 450, 1, 1900, 0.5),
                                                                                                 (107, 30, 593, 1, 285000, 0.5),
                                                                                                 (108, 31, 592, 6, 1710000, 3),
                                                                                                 (109, 32, 451, 10, 270000, 5),
                                                                                                 (110, 33, 589, 10, 4500000, 5),
                                                                                                 (111, 33, 593, 1, 285000, 0.5),
                                                                                                 (112, 34, 465, 1, 22500, 0.5),
                                                                                                 (113, 34, 468, 1, 22500, 0.5),
                                                                                                 (114, 35, 468, 10, 225000, 5),
                                                                                                 (115, 36, 613, 10, 6300000, 5),
                                                                                                 (116, 36, 629, 1, 285000, 0.5),
                                                                                                 (117, 37, 461, 10, 1584000, 5),
                                                                                                 (118, 37, 555, 10, 2760000, 5),
                                                                                                 (119, 38, 612, 3, 1584000, 1.5),
                                                                                                 (120, 38, 613, 20, 12600000, 10),
                                                                                                 (121, 39, 591, 10, 2850000, 5);


/*!40103 SET TIME_ZONE=IFNULL(@OLD_TIME_ZONE, 'system') */;
/*!40101 SET SQL_MODE=IFNULL(@OLD_SQL_MODE, '') */;
/*!40014 SET FOREIGN_KEY_CHECKS=1 */; -- Re-enable FK checks
